...
// Replace these with your actual uploaded images
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
        viewport={{ once: true, margin: "-100px" }}
        className="mb-12 md:mb-16 px-4 md:px-8 lg:px-20 text-center"
      >
        <div className="flex flex-col gap-2 items-center">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8, ease: "easeOut", delay: 0.2 }}
            viewport={{ once: true, margin: "-100px" }}
            className="h-[3px] bg-[#FFAE3D] mx-auto"
          />
      ...
      {/* Content Section */}
      <div className="px-4 md:px-8 lg:px-20 flex flex-col lg:flex-row gap-6 lg:gap-10 items-center justify-center">
        {/* Left Content */}
        <motion.div
          style={{ y: textY }}
          className="flex flex-col gap-5 w-full lg:w-[450px] items-center text-center"
        >
          {/* Description */}
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            ...
            className="font-['Inter'] font-normal text-base md:text-lg leading-relaxed text-[#463e4e]"
          >
            Refresh Global cells spreads across the world from within Benin to other states, expanding internationally from countries across.
          </motion.p>

          {/* Buttons */}
          <motion.div className="flex flex-col gap-4 w-full items-center">
            {/* Benin-Based Cell Button */}
            <motion.button
              onHoverStart={() => setHoveredButton("benin")}
              onHoverEnd={() => setHoveredButton(null)}
              whileHover={{ scale: 1.02, y: -2 }}
              whileTap={{ scale: 0.98 }}
              className="mx-auto relative bg-white h-[50px] md:h-[60px] lg:h-[65px] px-5 md:px-6 rounded-[67px] border-2 border-[#120124] w-full lg:w-fit transition-all duration-300 hover:shadow-lg group overflow-hidden text-sm md:text-base"
            >
              <motion.div
                className="absolute inset-0 bg-[#120124] rounded-[67px]"
                initial={{ scale: 0, opacity: 0 }}
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.02, y: -2 }}
              whileTap={{ scale: 0.98 }}
              className="mx-auto relative bg-[#ffae3d] h-[50px] md:h-[60px] lg:h-[65px] px-5 md:px-6 rounded-[67px] w-full lg:w-fit transition-all duration-300 hover:shadow-xl overflow-hidden text-sm md:text-base"
            >
              <motion.div
                className="absolute inset-0 bg-[#ff9e1d] rounded-[67px]"
                initial={{ scale: 0 }}
        ...
        <motion.div
          style={{ y: imagesY }}
          className="flex flex-col md:flex-row gap-5 w-full lg:flex-1 items-center justify-center"
        >
          {/* Large Image */}
          <motion.div
            initial={{ opacity: 0, scale: 0.95, x: -30 }}
          ...
          {/* Small Images Stack */}
          <div className="flex flex-row md:flex-col gap-5 w-full md:w-[45%] lg:w-[240px] items-center justify-center">
            {/* Top Small Image */}
            <motion.div
              initial={{ opacity: 0, scale: 0.95, y: -20 }}
              whileInView={{ opacity: 1, scale: 1, y: 0 }}
